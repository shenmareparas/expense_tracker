...
class _AddSplitPageState extends State<AddSplitPage> {
  ...
  String _mode = 'split'; // 'expense' or 'split'
  ...
  bool get _isFormValid {
    if (_mode == 'expense') {
      ...
      return _selectedPartners.isNotEmpty;
    }
  }
  ...
  Future<void> _saveEntry() async {
    ...
    try {
      if (_mode == 'expense') {
        ...
        } else if (mounted && transactionVM.errorMessage != null) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text(transactionVM.errorMessage!)),
          );
        }
      } else {
        ...
        // Add split records for partner(s)
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(_mode == 'expense' ? 'Add Expense' : 'Add Split Expense'),
        elevation: 0,
        ...
        child: Consumer2<CategoryViewModel, SplitViewModel>(
          builder: (context, categoryVM, splitVM, child) {
            ...
            return Selector<TransactionViewModel, bool>(
              ...
              builder: (context, isTransactionSaving, _) {
                final isSaving = isTransactionSaving || splitVM.isSaving;

                return ListView(
                  padding: const EdgeInsets.fromLTRB(24, 120, 24, 24),
                  children: [
                    // Mode Switch: Expense vs Split
                    Center(
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              if (profiles.isEmpty)
                                ...
                                Wrap(
                                  ...
                                  children: profiles.map((p) {
                                    final isSelected = _selectedPartners
                                        .contains(p);
                                    return FilterChip(
                            ...
                            if (_mode == 'expense') ...[
                              ...
                              AppDropdown<String>(
                                key: ValueKey('category_dropdown_$_mode'),
                                value: _category,
